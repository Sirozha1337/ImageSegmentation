% ћодель vMF, данные синтетические. ѕроцедура GrabCut. 
% ќтдельно рассмотреть разные варианты начальной сегментации: пользователем, kmeans, MLE с близкими к истинным значени€ми параметров.
