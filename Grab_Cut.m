...
function [sample, mus, kappas] = Grab_Cut(data, segment, k, lambda, sigma, mus, kappas, map_iter, max_iter, neighbours_count)
...
for i=1:max_iter
    ...
    % находим MAP
    [segment, ~] = MRF_MAP_GraphCutABSwap(segment, logprobs, Bpq, k, map_iter, neighbours_count);
end
